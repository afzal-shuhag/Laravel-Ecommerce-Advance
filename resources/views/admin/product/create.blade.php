...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.css" crossorigin="anonymous">
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <input type="file" id="file" class="custom-file-input" name="image_one" required="" onchange="readURL(this);" accept="image">
          ...
          <img src="#" id="one" >
              ...
              <div class="col-lg-4">
                ...
                <label class="custom-file">
          <input type="file" id="file" class="custom-file-input" name="image_two" required="" onchange="readURL1(this);" accept="image">
          <span class="custom-file-control"></span>
          <img src="#" id="two" >
        </label>
              </div>
              <div class="col-lg-4">
                ...
                <label class="custom-file">
          <input type="file" id="file" class="custom-file-input" name="image_three" required="" onchange="readURL2(this);" accept="//image">
          <span class="custom-file-control"></span>
          <img src="#" id="three" >
        </label>
              </div>
