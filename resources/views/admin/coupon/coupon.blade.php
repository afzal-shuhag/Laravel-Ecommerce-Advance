            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $row -> discount }}</td>
                  <td>
                  	<a href="{{ route('edit.coupon', $row->id) }}" class="btn btn-info btn-sm">Edit</a>
                  	<a href="{{ route('delete.coupon', $row->id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a>
                  </td>
                </tr>
                @endforeach
              ...
              <div class="modal-body pd-20">
               ...
               <form action="{{ route('store.coupon') }}" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="coupon" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="">
                </div>           
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Coupon Code(%)</label>
                  <input type="text" name="discount" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="">
                </div>
