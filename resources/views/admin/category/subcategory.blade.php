            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  	<a href="{{ route('edit.subcat',$row->id) }}" class="btn btn-info btn-sm">Edit</a>
                  	<a href="{{ route('delete.subcat',$row->id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a>
                  </td>
                </tr>
                @endforeach
              ...
              <div class="modal-body pd-20">
               ...
               <form action="{{ route('store.subcategory') }}" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="subcategory_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
